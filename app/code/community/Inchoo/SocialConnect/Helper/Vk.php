...
class Inchoo_SocialConnect_Helper_Vk extends Mage_Core_Helper_Abstract
{
    CONST SOCIAL_CONNECT_FACEBOOK_ID = 'inchoo_socialconnect_fid';
    CONST SOCIAL_CONNECT_GOOGLE_ID   = 'inchoo_socialconnect_gid';
    CONST SOCIAL_CONNECT_TWITTER_ID  = 'inchoo_socialconnect_tid';
    ...
    public function disconnect(Mage_Customer_Model_Customer $customer)
    {
        ...
        try {
            //$client->setAccessToken($customer->getInchooSocialconnectVtoken());
            //$client->api('/account.getAppPermissions', 'DELETE');
        } catch (Exception $e) { }
        ...
        $pictureFilename = Mage::getBaseDir(Mage_Core_Model_Store::URL_TYPE_MEDIA)
                ...
                .'vk'
                .DS                
                .$customer->getInchooSocialconnectVid();
     ...
     * @param $vkId
     * @param $token
     * @param int $append 1 - show generated email
     */
    public function connectByVkId(
            ...
            $token)
    {
        $customer->setInchooSocialconnectVid($vkId)
                ->setInchooSocialconnectVtoken($token)
                ->save();
            ...
            $token)
    {
        ...
        $customer->setEmail($email)
                ...
                ->setInchooSocialconnectVid($vkId)
                ->setInchooSocialconnectVtoken($token)
                ->setPassword($customer->generatePassword(10))
                ->setInchooSocialconnectVemail(1)
                ->save();
    ...
    public function getCustomersByVkId($vkId)
    {
        ...
        $collection = $customer->getCollection()
            ->addAttributeToFilter('inchoo_socialconnect_vid', $vkId)
            ->setPageSize(1);
